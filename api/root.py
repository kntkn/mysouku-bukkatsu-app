...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .feature-title { font-size: 1.3em; font-weight: 600; margin-bottom: 15px; }
        .feature-list { list-style: none; padding: 0; }
        .feature-list li { margin: 8px 0; padding-left: 25px; position: relative; }
        .feature-list li:before { content: "✅"; position: absolute; left: 0; }
        .unavailable:before { content: "❌"; }
        .button {
            display: inline-block; background: linear-gradient(135deg, #667eea, #764ba2);
            color: white; padding: 15px 30px; text-decoration: none;
            border-radius: 25px; font-weight: 600; margin: 10px;
...
<body>
    <div class="container">
        ...
        <div style="text-align: center; margin: 40px 0;">
            ...
            <a href="/api/health" class="button secondary">🔍 API ヘルスチェック</a>
        </div>
